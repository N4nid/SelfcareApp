  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.POST_NOTIFICATIONS) !=
      ...
      ActivityCompat.requestPermissions(
          this,
          Array<String>(1) { Manifest.permission.POST_NOTIFICATIONS },
          0
      )
    }
    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.FOREGROUND_SERVICE) !=
      ...
      ActivityCompat.requestPermissions(
          this,
          Array<String>(1) { Manifest.permission.FOREGROUND_SERVICE },
          0
      )
    }
    ...
    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.FOREGROUND_SERVICE) !=
      ...
      ActivityCompat.requestPermissions(
          this,
          Array<String>(1) { Manifest.permission.START_FOREGROUND_SERVICES_FROM_BACKGROUND },
          0
      )
      ActivityCompat.requestPermissions(
          this,
...
class bgService : Service() {
  ...
  inner class ActionReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
      ...
      // else if
      // (intent.hasExtra("received"))Toast.makeText(context,"mood",Toast.LENGTH_SHORT).show()
